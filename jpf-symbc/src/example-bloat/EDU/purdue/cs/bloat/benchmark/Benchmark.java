...
/**
 * This class is used to run a benchmark Java program with Perfmon
 * running in the background.  Perfmon is a software package developed
 * at Michigan State University that allows user-level programs to
 * access the hardware counters on Sparc processors.
 *
 * <p>
 *
 * The <tt>main</tt> method of this class takes several arguments
 * (note that the first four arguments are mutually exclusive):
 *
 * <pre>
 ...
 * </pre> 
 *
 * The real work is done by the native <tt>run</tt> method that is

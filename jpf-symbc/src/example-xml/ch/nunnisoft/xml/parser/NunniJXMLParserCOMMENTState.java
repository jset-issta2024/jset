/*
 * $Id: NunniJXMLParserCOMMENTState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCOMMENTState extends NunniJXMLParserState
{
    private static NunniJXMLParserCOMMENTState m_instance = null;


    private NunniJXMLParserCOMMENTState() {}


    static NunniJXMLParserCOMMENTState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCOMMENTState();
        return m_instance;
    }
    ...
    void minus( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserCOMMENTCState.instance() );
    }

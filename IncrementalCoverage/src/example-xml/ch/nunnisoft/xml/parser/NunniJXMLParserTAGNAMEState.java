/*
 * $Id: NunniJXMLParserTAGNAMEState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserTAGNAMEState extends NunniJXMLParserState
{
    private static NunniJXMLParserTAGNAMEState m_instance = null;


    private NunniJXMLParserTAGNAMEState() {}


    static NunniJXMLParserTAGNAMEState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserTAGNAMEState();
        return m_instance;
    }
    ...
    void closebracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ctx.tagnameClosebracket( o );
        }
        catch( LogicError e ) {
            ctx.changeState( NunniJXMLParserTEXTState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserTEXTState.instance() );
    }
    ...
    void minus( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.tagnameLiteral( o );
    }


    void whitespace( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserTAGARGSState.instance() );
    }


    void slash( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserSINGLETAGState.instance() );
    }

/*
 * $Id: NunniJXMLParserTAGARGSWState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserTAGARGSWState extends NunniJXMLParserState
{
    private static NunniJXMLParserTAGARGSWState m_instance = null;


    private NunniJXMLParserTAGARGSWState() {}


    static NunniJXMLParserTAGARGSWState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserTAGARGSWState();
        return m_instance;
    }

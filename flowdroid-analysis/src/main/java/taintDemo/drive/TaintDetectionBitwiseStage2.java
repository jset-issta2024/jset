...
public class TaintDetectionBitwiseStage2 {
...
//        setTaintParameters4SweepSolver();
        ...
        if (args.length == 0) {
            ...
            try {
                PrintStream print = new PrintStream("/home/lmx/Documents/GitHub/jpf-concolic/jpf-concolic/expeResult/taint/bitwiseS2/" + fileName + "-" + entryName + ".log");
                System.setOut(print);
...
//    }
    ...
    private static void setTaintParameters4Bitwise() {
        ...
        String sink5 = "<featureDetection.InstrumentHelper: int bitwiseHelper(int,int,int)>";

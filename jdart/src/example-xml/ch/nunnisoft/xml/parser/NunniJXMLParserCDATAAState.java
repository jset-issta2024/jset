/*
 * $Id: NunniJXMLParserCDATAAState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCDATAAState extends NunniJXMLParserState
{
    private static NunniJXMLParserCDATAAState m_instance = null;


    private NunniJXMLParserCDATAAState() {}


    static NunniJXMLParserCDATAAState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCDATAAState();
        return m_instance;
    }

...
//			token = Debug.makeConcolicInteger("sym_token_" + (token_index), "" + token , "1");
			token = Debug.makeSymbolicInteger("" + token);
		}
...
//			System.out.println(line);  
		...
		char a=c;
		if(a!='\n' && a!=' '){
			if(SieConfig.SYMB_FLAG)
				a=Debug.makeSymbolicChar(""+(int)c);
//				a=Debug.makeConcolicChar("sym_cnf_char"+char_index, ""+(int)c);
		}

...
public class TaintDetectionBitwise {
...
//        setTaintParameters4SweepSolver();
        ...
        if (args.length == 0) {
            ...
            try {
                PrintStream print = new PrintStream("/home/lmx/Documents/GitHub/jpf-concolic/jpf-concolic/expeResult/taint/bitwise/" + fileName + "-" + entryName + ".log");
                System.setOut(print);

/*
 * $Id: NunniJXMLParserTAGSTARTState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserTAGSTARTState extends NunniJXMLParserState
{
    private static NunniJXMLParserTAGSTARTState m_instance = null;


    private NunniJXMLParserTAGSTARTState() {}


    static NunniJXMLParserTAGSTARTState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserTAGSTARTState();
        return m_instance;
    }
    ...
    void slash( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ...
            ctx.changeState( NunniJXMLParserCLOSETAGNAMEState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserCLOSETAGNAMEState.instance() );
    }

/*
 * $Id: NunniJXMLParserLVALUEENDState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserLVALUEENDState extends NunniJXMLParserState
{
    private static NunniJXMLParserLVALUEENDState m_instance = null;


    private NunniJXMLParserLVALUEENDState() {}


    static NunniJXMLParserLVALUEENDState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserLVALUEENDState();
        return m_instance;
    }

...
public class TestLIA4J {

    public void start() {
        double a[][] = new double[][] {
        		{14.0, 6.0, 9.9 , 6.0, 9.9 ,14.0,},
                {4.0,  6.0, 9.9 , 6.0, 9.9 ,14.0,},
                {14.0, 76.0, 8.9, 6.0, 9.9 ,14.0,},
                {14.0, 76.0, 8.9, 6.0, 9.9 ,14.0,},
                {14.0, 76.0, 8.9, 6.0, 9.9 ,14.0,},
                {14.0, 76.0, 8.9, 6.0, 9.9 ,14.0,},
        };
...
//        new GaussianSolverTest().performTest(a, b);

//        new EigenDecompositorTest().performTest(a, c);
//        new SingularValueDecompositorTest().performTest(a, c);
//        new CholeskyDecompositorTest().performTest(a, c);
//        new QRDecompositorTest().performTest(a, c);
//        new LUDecompositorTest().performTest(a, c);

//        GaussJordanInverterTest tt= new GaussJordanInverterTest();
...
//        new ForwardBackSubstitutionSolverTest().performTest(d,e);
//        new JacobiSolverTest().performTest(d,e);
//        new LeastSquaresSolverTest().performTest(d,e);
//        new SeidelSolverTest().performTest(d,e);
//        new SquareRootSolverTest().performTest(d,e);
//        new SweepSolverTest().performTest(d,e);
//        SweepSolverTest

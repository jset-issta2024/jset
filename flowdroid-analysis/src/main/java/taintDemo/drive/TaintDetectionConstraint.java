...
public class TaintDetectionConstraint {
...
//        setTaintParameters4SweepSolver();
        ...
        if (args.length == 0) {
            ...
            try {
                PrintStream print = new PrintStream("/home/lmx/Documents/GitHub/jpf-concolic/jpf-concolic/expeResult/taint/constraint/" + fileName + "-" + entryName + ".log");
                System.setOut(print);

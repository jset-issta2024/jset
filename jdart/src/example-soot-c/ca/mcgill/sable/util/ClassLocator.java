...
import sootc.net.sf.jazzlib.ZipEntry;
import sootc.net.sf.jazzlib.ZipFile;
...
public class ClassLocator
{
    ...
    public static InputStream getInputStreamOf(String className) throws ClassNotFoundException
    {
    	...
    	return getInputStreamOf("build/example-soot-c:src/example-soot-c/rt.jar", className);
    }

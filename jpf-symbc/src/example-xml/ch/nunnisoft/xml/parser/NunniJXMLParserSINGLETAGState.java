/*
 * $Id: NunniJXMLParserSINGLETAGState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserSINGLETAGState extends NunniJXMLParserState
{
    private static NunniJXMLParserSINGLETAGState m_instance = null;


    private NunniJXMLParserSINGLETAGState() {}


    static NunniJXMLParserSINGLETAGState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserSINGLETAGState();
        return m_instance;
    }

...
//		System.out.println(t2.beginLine+" "+t2.beginColumn+" "+t2.endLine+" "+t2.endColumn);
		if(t1==null)
			return false;
		return (t1.image.equals(t2.image)&& t1.beginLine==t2.beginLine && t1.beginColumn==t2.beginColumn && t1.endLine==t2.endLine &&  t1.kind==t2.kind && t1.endColumn==t2.endColumn);
	}

/*
 * $Id: NunniJXMLParserCLOSETAGNAMEState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCLOSETAGNAMEState extends NunniJXMLParserState
{
    private static NunniJXMLParserCLOSETAGNAMEState m_instance = null;


    private NunniJXMLParserCLOSETAGNAMEState() {}


    static NunniJXMLParserCLOSETAGNAMEState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCLOSETAGNAMEState();
        return m_instance;
    }
    ...
    void closebracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ctx.closetagnameClosebracket( o );
        }
        catch( LogicError e ) {

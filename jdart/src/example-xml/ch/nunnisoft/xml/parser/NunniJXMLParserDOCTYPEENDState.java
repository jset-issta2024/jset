/*
 * $Id: NunniJXMLParserDOCTYPEENDState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserDOCTYPEENDState extends NunniJXMLParserState
{
    private static NunniJXMLParserDOCTYPEENDState m_instance = null;


    private NunniJXMLParserDOCTYPEENDState() {}


    static NunniJXMLParserDOCTYPEENDState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserDOCTYPEENDState();
        return m_instance;
    }
    ...
    void closebracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserPREState.instance() );
    }

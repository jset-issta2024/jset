/*
 * $Id: NunniJXMLParserCDATABState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCDATABState extends NunniJXMLParserState
{
    private static NunniJXMLParserCDATABState m_instance = null;


    private NunniJXMLParserCDATABState() {}


    static NunniJXMLParserCDATABState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCDATABState();
        return m_instance;
    }
    ...
    void closesqbracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ctx.cdatabClosesqbracket( o );
        }
        catch( LogicError e ) {
            ctx.changeState( NunniJXMLParserCDATACState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserCDATACState.instance() );
    }

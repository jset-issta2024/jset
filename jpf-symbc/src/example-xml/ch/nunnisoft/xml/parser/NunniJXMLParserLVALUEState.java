/*
 * $Id: NunniJXMLParserLVALUEState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserLVALUEState extends NunniJXMLParserState
{
    private static NunniJXMLParserLVALUEState m_instance = null;


    private NunniJXMLParserLVALUEState() {}


    static NunniJXMLParserLVALUEState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserLVALUEState();
        return m_instance;
    }
    ...
    void whitespace( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserLVALUEENDState.instance() );
    }
    ...
    void equal( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserEQUALState.instance() );
    }

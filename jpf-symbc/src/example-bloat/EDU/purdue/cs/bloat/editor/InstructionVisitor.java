...
/**
 * The visitor pattern allows functionality to be added to a number of
 * classes (or in this case one class, <tt>Instruction</tt>, that can
 * vary in behavior) without modifying the classes themselves.  
 * Additionally, the visitor pattern simulates double dispatching.  For
 * instance <tt>visit</tt> method of <tt>Instruction</tt> calls a 
 * particular method of <tt>InstructionVisitor</tt> based on the 
 * <tt>Instruction</tt>'s opcode.
 * <p>
 * <tt>InstructionVisitor</tt> provides an interface for performing 
 * actions based on the instruction type.  Classes implementing this
 * interface should not be able to miss any of the instruction types.
 * This interface was created as an alternative to having 138 different
 * subtypes of Instruction.
 * 

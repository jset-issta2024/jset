package com.antlr.instr;// $ANTLR 2.7.7 (20060906): "instr.g" -> "InstrLexer.java"$
...
public class InstrLexer extends CharScanner implements InstrParserTokenTypes, TokenStream
 {

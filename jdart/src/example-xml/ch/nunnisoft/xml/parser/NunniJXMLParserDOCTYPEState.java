/*
 * $Id: NunniJXMLParserDOCTYPEState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserDOCTYPEState extends NunniJXMLParserState
{
    private static NunniJXMLParserDOCTYPEState m_instance = null;


    private NunniJXMLParserDOCTYPEState() {}


    static NunniJXMLParserDOCTYPEState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserDOCTYPEState();
        return m_instance;
    }
    ...
    void questionmark( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserDOCTYPEENDState.instance() );
    }

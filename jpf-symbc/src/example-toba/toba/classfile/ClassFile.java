...
public class ClassFile extends MyDataInputStream { //extends FilterInputStream implements DataInput {
...
{
    super(new SymbolicBufferedInputStream(input, classBufferSize));
}

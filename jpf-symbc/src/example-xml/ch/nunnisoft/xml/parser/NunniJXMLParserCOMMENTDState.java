/*
 * $Id: NunniJXMLParserCOMMENTDState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCOMMENTDState extends NunniJXMLParserState
{
    private static NunniJXMLParserCOMMENTDState m_instance = null;


    private NunniJXMLParserCOMMENTDState() {}


    static NunniJXMLParserCOMMENTDState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCOMMENTDState();
        return m_instance;
    }

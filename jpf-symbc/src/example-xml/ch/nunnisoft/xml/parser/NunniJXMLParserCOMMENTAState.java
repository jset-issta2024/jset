/*
 * $Id: NunniJXMLParserCOMMENTAState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCOMMENTAState extends NunniJXMLParserState
{
    private static NunniJXMLParserCOMMENTAState m_instance = null;


    private NunniJXMLParserCOMMENTAState() {}


    static NunniJXMLParserCOMMENTAState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCOMMENTAState();
        return m_instance;
    }
    ...
    void opensqbracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ctx.commentaOpensqbracket( o );
        }
        catch( LogicError e ) {
            ctx.changeState( NunniJXMLParserCDATAAState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserCDATAAState.instance() );
    }
    ...
    void minus( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserCOMMENTBState.instance() );
    }
    ...
    void literal( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ...
            ctx.changeState( NunniJXMLParserDTDAState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserDTDAState.instance() );
    }

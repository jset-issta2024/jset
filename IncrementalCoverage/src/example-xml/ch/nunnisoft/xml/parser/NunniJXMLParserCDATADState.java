/*
 * $Id: NunniJXMLParserCDATADState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCDATADState extends NunniJXMLParserState
{
    private static NunniJXMLParserCDATADState m_instance = null;


    private NunniJXMLParserCDATADState() {}


    static NunniJXMLParserCDATADState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCDATADState();
        return m_instance;
    }

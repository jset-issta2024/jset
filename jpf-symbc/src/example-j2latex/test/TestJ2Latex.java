...
//		An exception happens 1!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!: java.lang.NumberFormatException
//		at java.lang.Integer.parseInt(Integer.java)
//		at com.github.situx.compiler.parser.C1.unary(C1.java:2776)
//		class SampleInter { SampleInter ( ) { return null ; 0L ;
		String s = "class SampleInter { SampleInter ( ) {  return null; } }";

//		s = FileUtils.readString("inputs/J2latex.input");

		s = "public abstract class Sample < T , E > extends Object implements SampleInter < T , E > { public Sample () { supeb ();} }";

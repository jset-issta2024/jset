...
/**
 * <tt>Stats</tt> is used to run a benchmark using an instrumented
 * Java Virtual machine that counts the number of each kind of
 * bytecodes executed.  The counts are maintained in two C variables,
 * <tt>instruction_count</tt> and <tt>redundant_count</tt>.
 */
public class Stats {

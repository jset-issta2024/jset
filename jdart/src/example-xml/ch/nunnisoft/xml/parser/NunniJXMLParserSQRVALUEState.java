/*
 * $Id: NunniJXMLParserSQRVALUEState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserSQRVALUEState extends NunniJXMLParserState
{
    private static NunniJXMLParserSQRVALUEState m_instance = null;


    private NunniJXMLParserSQRVALUEState() {}


    static NunniJXMLParserSQRVALUEState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserSQRVALUEState();
        return m_instance;
    }

...
class TypeResolver
{
    ...
    private TypeResolver(SootClassManager classManager)
    {
    ...
    public static TypeResolver getClassHierarchy(SootClassManager classManager)
    {
        TypeResolver classHierarchy =
            (TypeResolver) classHierarchyHashtable.get(classManager);

        if(classHierarchy == null)
        {
            classHierarchy = new TypeResolver(classManager);
        }

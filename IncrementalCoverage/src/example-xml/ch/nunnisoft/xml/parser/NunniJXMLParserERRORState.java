/*
 * $Id: NunniJXMLParserERRORState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserERRORState extends NunniJXMLParserState
{
    private static NunniJXMLParserERRORState m_instance = null;


    private NunniJXMLParserERRORState() {}


    static NunniJXMLParserERRORState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserERRORState();
        return m_instance;
    }

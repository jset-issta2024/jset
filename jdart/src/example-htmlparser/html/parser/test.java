...
System.out.print(Selected+" - > "+content+'\n');
 ...
 {
    if (jj_scan_token(ST_TITLE)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_20()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_TITLE)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_SUMMARY)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_36()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_SUMMARY)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_TR)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_19()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_TR)) return true;
    return false;
  }

  private boolean jj_3R_30()
 {
    if (jj_scan_token(ST_DETAILS)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_32()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_DETAILS)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_H6)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_45()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_H6)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_H5)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_44()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_H5)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_H4)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_43()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_H4)) return true;
    return false;
  }

  private boolean jj_3R_34()
 {
    if (jj_scan_token(ST_TD)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_18()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_TD)) return true;
    return false;
  }

  private boolean jj_3R_36()
 {
    if (jj_scan_token(ST_SPAN)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_31()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_SPAN)) return true;
    return false;
  }

  private boolean jj_3_48()
 {
    if (jj_scan_token(ST_H3)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_42()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_H3)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_H2)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_41()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_H2)) return true;
    return false;
  }

  private boolean jj_3_46()
 {
    if (jj_scan_token(ST_H1)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_40()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_H1)) return true;
    return false;
  }

  private boolean jj_3R_31()
 {
    if (jj_scan_token(ST_TABLE)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_17()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_TABLE)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_DIV)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_23()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_DIV)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_BUTTON)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_39()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_BUTTON)) return true;
    return false;
  }

  private boolean jj_3R_27()
 {
    if (jj_scan_token(ST_IMG)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_A)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_22()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_A)) return true;
    return false;
  }

  private boolean jj_3R_38()
 {
    if (jj_scan_token(ST_LI)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_38()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_LI)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_P)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_21()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_P)) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ST_OL)) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
      if (jj_3_37()) { jj_scanpos = xsp; break; }
    }
    if (jj_scan_token(ND_OL)) return true;
    return false;
  }

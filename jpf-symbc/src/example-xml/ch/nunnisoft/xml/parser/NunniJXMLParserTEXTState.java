/*
 * $Id: NunniJXMLParserTEXTState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserTEXTState extends NunniJXMLParserState
{
    private static NunniJXMLParserTEXTState m_instance = null;


    private NunniJXMLParserTEXTState() {}


    static NunniJXMLParserTEXTState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserTEXTState();
        return m_instance;
    }


    void openbracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserTAGSTARTState.instance() );
    }
    ...
    void end( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ...
            ctx.changeState( NunniJXMLParserENDState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserENDState.instance() );
    }

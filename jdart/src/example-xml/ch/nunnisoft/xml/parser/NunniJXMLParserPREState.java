/*
 * $Id: NunniJXMLParserPREState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserPREState extends NunniJXMLParserState
{
    private static NunniJXMLParserPREState m_instance = null;


    private NunniJXMLParserPREState() {}


    static NunniJXMLParserPREState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserPREState();
        return m_instance;
    }
    ...
    void openbracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ctx.preOpenbracket( o );
        }
        catch( LogicError e ) {
            ctx.changeState( NunniJXMLParserPRETAGSTARTState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserPRETAGSTARTState.instance() );
    }

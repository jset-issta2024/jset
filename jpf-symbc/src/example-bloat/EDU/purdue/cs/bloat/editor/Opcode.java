...
/**
 * Opcode is an interface containing constants defining the opcodes
 * of instructions and related constants.
 * <ul>
 * <li> opc_XXX are the opcodes.
 *
 * <li> opcx_XXX are the opcode classes.  These are used externally
 * by Instruction.
 *
 * <li> opcNames is an array of opcode names, indexed by the opcode.
 *
 * <li> opcSize is an array of the bytecode instruction lengths,
...
public interface Opcode
{
    ...
    /**
     * Opcode class for nop, xxxunusedxxx, wide, breakpoint,
     * and opcodes 203-254.
     */
    public static final int opcx_nop             = opc_nop;


    /**
     * Opcode class for aconst_null, iconst_m1, iconst_0,
     ...
     */
    public static final int opcx_ldc             = opc_ldc;

    /**
     * Opcode class for iload, iload_0, iload_1, iload_2, iload_3.
     */
    public static final int opcx_iload           = opc_iload;

    /**
     * Opcode class for lload, lload_0, lload_1, lload_2, lload_3.
     */
    public static final int opcx_lload           = opc_lload;

    /**
     * Opcode class for fload, fload_0, fload_1, fload_2, fload_3.
     */
    public static final int opcx_fload           = opc_fload;

    /**
     * Opcode class for dload, dload_0, dload_1, dload_2, dload_3.
     */
    public static final int opcx_dload           = opc_dload;

    /**
     * Opcode class for aload, aload_0, aload_1, aload_2, aload_3.
     */
    public static final int opcx_aload           = opc_aload;

    /**
     * Opcode class for iaload.
     */
    public static final int opcx_iaload          = opc_iaload;

    /**
     * Opcode class for laload.
     */
    public static final int opcx_laload          = opc_laload;

    /**
     * Opcode class for faload.
     */
    public static final int opcx_faload          = opc_faload;

    /**
     * Opcode class for daload.
     */
    public static final int opcx_daload          = opc_daload;

    /**
     * Opcode class for aaload.
     */
    public static final int opcx_aaload          = opc_aaload;

    /**
     * Opcode class for baload.
     */
    public static final int opcx_baload          = opc_baload;

    /**
     * Opcode class for caload.
     */
    public static final int opcx_caload          = opc_caload;

    /**
     * Opcode class for saload.
     */
    public static final int opcx_saload          = opc_saload;

    /**
     * Opcode class for istore, istore_0, istore_1, istore_2, istore_3.
     */
    public static final int opcx_istore          = opc_istore;

    /**
     * Opcode class for lstore, lstore_0, lstore_1, lstore_2, lstore_3.
     */
    public static final int opcx_lstore          = opc_lstore;

    /**
     * Opcode class for fstore, fstore_0, fstore_1, fstore_2, fstore_3.
     */
    public static final int opcx_fstore          = opc_fstore;

    /**
     * Opcode class for dstore, dstore_0, dstore_1, dstore_2, dstore_3.
     */
    public static final int opcx_dstore          = opc_dstore;

    /**
     * Opcode class for astore, astore_0, astore_1, astore_2, astore_3.
     */
    public static final int opcx_astore          = opc_astore;

    /**
     * Opcode class for iastore.
     */
    public static final int opcx_iastore         = opc_iastore;

    /**
     * Opcode class for lastore.
     */
    public static final int opcx_lastore         = opc_lastore;

    /**
     * Opcode class for fastore.
     */
    public static final int opcx_fastore         = opc_fastore;

    /**
     * Opcode class for dastore.
     */
    public static final int opcx_dastore         = opc_dastore;

    /**
     * Opcode class for aastore.
     */
    public static final int opcx_aastore         = opc_aastore;

    /**
     * Opcode class for bastore.
     */
    public static final int opcx_bastore         = opc_bastore;

    /**
     * Opcode class for castore.
     */
    public static final int opcx_castore         = opc_castore;

    /**
     * Opcode class for sastore.
     */
    public static final int opcx_sastore         = opc_sastore;

    /**
     * Opcode class for pop.
     */
    public static final int opcx_pop             = opc_pop;

    /**
     * Opcode class for pop2.
     */
    public static final int opcx_pop2            = opc_pop2;

    /**
     * Opcode class for dup.
     */
    public static final int opcx_dup             = opc_dup;

    /**
     * Opcode class for dup_x1.
     */
    public static final int opcx_dup_x1          = opc_dup_x1;

    /**
     * Opcode class for dup_x2.
     */
    public static final int opcx_dup_x2          = opc_dup_x2;

    /**
     * Opcode class for dup2.
     */
    public static final int opcx_dup2            = opc_dup2;

    /**
     * Opcode class for dup2_x1.
     */
    public static final int opcx_dup2_x1         = opc_dup2_x1;

    /**
     * Opcode class for dup2_x2.
     */
    public static final int opcx_dup2_x2         = opc_dup2_x2;

    /**
     * Opcode class for swap.
     */
    public static final int opcx_swap            = opc_swap;

    /**
     * Opcode class for iadd.
     */
    public static final int opcx_iadd            = opc_iadd;

    /**
     * Opcode class for ladd.
     */
    public static final int opcx_ladd            = opc_ladd;

    /**
     * Opcode class for fadd.
     */
    public static final int opcx_fadd            = opc_fadd;

    /**
     * Opcode class for dadd.
     */
    public static final int opcx_dadd            = opc_dadd;

    /**
     * Opcode class for isub.
     */
    public static final int opcx_isub            = opc_isub;

    /**
     * Opcode class for lsub.
     */
    public static final int opcx_lsub            = opc_lsub;

    /**
     * Opcode class for fsub.
     */
    public static final int opcx_fsub            = opc_fsub;

    /**
     * Opcode class for dsub.
     */
    public static final int opcx_dsub            = opc_dsub;

    /**
     * Opcode class for imul.
     */
    public static final int opcx_imul            = opc_imul;

    /**
     * Opcode class for lmul.
     */
    public static final int opcx_lmul            = opc_lmul;

    /**
     * Opcode class for fmul.
     */
    public static final int opcx_fmul            = opc_fmul;

    /**
     * Opcode class for dmul.
     */
    public static final int opcx_dmul            = opc_dmul;

    /**
     * Opcode class for idiv.
     */
    public static final int opcx_idiv            = opc_idiv;

    /**
     * Opcode class for ldiv.
     */
    public static final int opcx_ldiv            = opc_ldiv;

    /**
     * Opcode class for fdiv.
     */
    public static final int opcx_fdiv            = opc_fdiv;

    /**
     * Opcode class for ddiv.
     */
    public static final int opcx_ddiv            = opc_ddiv;

    /**
     * Opcode class for irem.
     */
    public static final int opcx_irem            = opc_irem;

    /**
     * Opcode class for lrem.
     */
    public static final int opcx_lrem            = opc_lrem;

    /**
     * Opcode class for frem.
     */
    public static final int opcx_frem            = opc_frem;

    /**
     * Opcode class for drem.
     */
    public static final int opcx_drem            = opc_drem;

    /**
     * Opcode class for ineg.
     */
    public static final int opcx_ineg            = opc_ineg;

    /**
     * Opcode class for lneg.
     */
    public static final int opcx_lneg            = opc_lneg;

    /**
     * Opcode class for fneg.
     */
    public static final int opcx_fneg            = opc_fneg;

    /**
     * Opcode class for dneg.
     */
    public static final int opcx_dneg            = opc_dneg;

    /**
     * Opcode class for ishl.
     */
    public static final int opcx_ishl            = opc_ishl;

    /**
     * Opcode class for lshl.
     */
    public static final int opcx_lshl            = opc_lshl;

    /**
     * Opcode class for ishr.
     */
    public static final int opcx_ishr            = opc_ishr;

    /**
     * Opcode class for lshr.
     */
    public static final int opcx_lshr            = opc_lshr;

    /**
     * Opcode class for iushr.
     */
    public static final int opcx_iushr           = opc_iushr;

    /**
     * Opcode class for lushr.
     */
    public static final int opcx_lushr           = opc_lushr;

    /**
     * Opcode class for iand.
     */
    public static final int opcx_iand            = opc_iand;

    /**
     * Opcode class for land.
     */
    public static final int opcx_land            = opc_land;

    /**
     * Opcode class for ior.
     */
    public static final int opcx_ior             = opc_ior;

    /**
     * Opcode class for lor.
     */
    public static final int opcx_lor             = opc_lor;

    /**
     * Opcode class for ixor.
     */
    public static final int opcx_ixor            = opc_ixor;

    /**
     * Opcode class for lxor.
     */
    public static final int opcx_lxor            = opc_lxor;

    /**
     * Opcode class for iinc.
     */
    public static final int opcx_iinc            = opc_iinc;

    /**
     * Opcode class for i2l.
     */
    public static final int opcx_i2l             = opc_i2l;

    /**
     * Opcode class for i2f.
     */
    public static final int opcx_i2f             = opc_i2f;

    /**
     * Opcode class for i2d.
     */
    public static final int opcx_i2d             = opc_i2d;

    /**
     * Opcode class for l2i.
     */
    public static final int opcx_l2i             = opc_l2i;

    /**
     * Opcode class for l2f.
     */
    public static final int opcx_l2f             = opc_l2f;

    /**
     * Opcode class for l2d.
     */
    public static final int opcx_l2d             = opc_l2d;

    /**
     * Opcode class for f2i.
     */
    public static final int opcx_f2i             = opc_f2i;

    /**
     * Opcode class for f2l.
     */
    public static final int opcx_f2l             = opc_f2l;

    /**
     * Opcode class for f2d.
     */
    public static final int opcx_f2d             = opc_f2d;

    /**
     * Opcode class for d2i.
     */
    public static final int opcx_d2i             = opc_d2i;

    /**
     * Opcode class for d2l.
     */
    public static final int opcx_d2l             = opc_d2l;

    /**
     * Opcode class for d2f.
     */
    public static final int opcx_d2f             = opc_d2f;

    /**
     * Opcode class for i2b.
     */
    public static final int opcx_i2b             = opc_i2b;

    /**
     * Opcode class for i2c.
     */
    public static final int opcx_i2c             = opc_i2c;

    /**
     * Opcode class for i2s.
     */
    public static final int opcx_i2s             = opc_i2s;

    /**
     * Opcode class for lcmp.
     */
    public static final int opcx_lcmp            = opc_lcmp;

    /**
     * Opcode class for fcmpl.
     */
    public static final int opcx_fcmpl           = opc_fcmpl;

    /**
     * Opcode class for fcmpg.
     */
    public static final int opcx_fcmpg           = opc_fcmpg;

    /**
     * Opcode class for dcmpl.
     */
    public static final int opcx_dcmpl           = opc_dcmpl;

    /**
     * Opcode class for dcmpg.
     */
    public static final int opcx_dcmpg           = opc_dcmpg;

    /**
     * Opcode class for ifeq.
     */
    public static final int opcx_ifeq            = opc_ifeq;

    /**
     * Opcode class for ifne.
     */
    public static final int opcx_ifne            = opc_ifne;

    /**
     * Opcode class for iflt.
     */
    public static final int opcx_iflt            = opc_iflt;

    /**
     * Opcode class for ifge.
     */
    public static final int opcx_ifge            = opc_ifge;

    /**
     * Opcode class for ifgt.
     */
    public static final int opcx_ifgt            = opc_ifgt;

    /**
     * Opcode class for ifle.
     */
    public static final int opcx_ifle            = opc_ifle;

    /**
     * Opcode class for if_icmpeq.
     */
    public static final int opcx_if_icmpeq       = opc_if_icmpeq;

    /**
     * Opcode class for if_icmpne.
     */
    public static final int opcx_if_icmpne       = opc_if_icmpne;

    /**
     * Opcode class for if_icmplt.
     */
    public static final int opcx_if_icmplt       = opc_if_icmplt;

    /**
     * Opcode class for if_icmpge.
     */
    public static final int opcx_if_icmpge       = opc_if_icmpge;

    /**
     * Opcode class for if_icmpgt.
     */
    public static final int opcx_if_icmpgt       = opc_if_icmpgt;

    /**
     * Opcode class for if_icmple.
     */
    public static final int opcx_if_icmple       = opc_if_icmple;

    /**
     * Opcode class for if_acmpeq.
     */
    public static final int opcx_if_acmpeq       = opc_if_acmpeq;

    /**
     * Opcode class for if_acmpne.
     */
    public static final int opcx_if_acmpne       = opc_if_acmpne;

    /**
     * Opcode class for goto, goto_w.
     */
    public static final int opcx_goto            = opc_goto;

    /**
     * Opcode class for jsr, jsr_w.
     */
    public static final int opcx_jsr             = opc_jsr;

    /**
     * Opcode class for ret.
     */
    public static final int opcx_ret             = opc_ret;

    /**
     * Opcode class for tableswitch, lookupswitch.
     */
    public static final int opcx_switch          = opc_tableswitch;

    /**
     * Opcode class for ireturn.
     */
    public static final int opcx_ireturn         = opc_ireturn;

    /**
     * Opcode class for lreturn.
     */
    public static final int opcx_lreturn         = opc_lreturn;

    /**
     * Opcode class for freturn.
     */
    public static final int opcx_freturn         = opc_freturn;

    /**
     * Opcode class for dreturn.
     */
    public static final int opcx_dreturn         = opc_dreturn;

    /**
     * Opcode class for areturn.
     */
    public static final int opcx_areturn         = opc_areturn;

    /**
     * Opcode class for return.
     */
    public static final int opcx_return          = opc_return;

    /**
     * Opcode class for getstatic.
     */
    public static final int opcx_getstatic       = opc_getstatic;

    /**
     * Opcode class for putstatic.
     */
    public static final int opcx_putstatic       = opc_putstatic;

    /**
     * Opcode class for getfield.
     */
    public static final int opcx_getfield        = opc_getfield;

    /**
     * Opcode class for putfield.
     */
    public static final int opcx_putfield        = opc_putfield;

    /**
     * Opcode class for invokevirtual.
     */
    public static final int opcx_invokevirtual   = opc_invokevirtual;

    /**
     * Opcode class for invokespecial.
     */
    public static final int opcx_invokespecial   = opc_invokespecial;

    /**
     * Opcode class for invokestatic.
     */
    public static final int opcx_invokestatic    = opc_invokestatic;

    /**
     * Opcode class for invokeinterface.
     */
    public static final int opcx_invokeinterface = opc_invokeinterface;

    /**
     * Opcode class for new.
     */
    public static final int opcx_new             = opc_new;

    /**
     * Opcode class for newarray, anewarray.
     */
    public static final int opcx_newarray        = opc_newarray;

    /**
     * Opcode class for arraylength.
     */
    public static final int opcx_arraylength     = opc_arraylength;

    /**
     * Opcode class for athrow.
     */
    public static final int opcx_athrow          = opc_athrow;

    /**
     * Opcode class for checkcast.
     */
    public static final int opcx_checkcast       = opc_checkcast;

    /**
     * Opcode class for instanceof.
     */
    public static final int opcx_instanceof      = opc_instanceof;

    /**
     * Opcode class for monitorenter.
     */
    public static final int opcx_monitorenter    = opc_monitorenter;

    /**
     * Opcode class for monitorexit.
     */
    public static final int opcx_monitorexit     = opc_monitorexit;

    /**
     * Opcode class for multianewarray.
     */
    public static final int opcx_multianewarray  = opc_multianewarray;

    /**
     * Opcode class for ifnull.
     */
    public static final int opcx_ifnull          = opc_ifnull;

    /**
     * Opcode class for ifnonnull.
     */
    public static final int opcx_ifnonnull       = opc_ifnonnull;

    /**
     * Opcode class for supdate.
     */
    public static final int opcx_aupdate         = opc_aupdate;

    /**
     * Opcode class for supdate.
     */
    public static final int opcx_supdate         = opc_supdate;

    /**
     * Opcode class for rc.
     */
    public static final int opcx_rc              = opc_rc;
    
     /**
     * Opcode class for aswizzle.
     */
    public static final int opcx_aswizzle         = opc_aswizzle;

   /**
     * Opcode class for aswrange.
     */
    public static final int opcx_aswrange         = opc_aswrange;

   /**
     * Opcode class for putfield_nowb.
     */
    public static final int opcx_putfield_nowb    = opc_putfield_nowb;

   /**
     * Opcode class for putstatic_nowb.
     */
    public static final int opcx_putstatic_nowb   = opc_putstatic_nowb;
    ...
    /**
     * VARIABLE represent either variable instruction length or a
     * variable effect on the operand stack, depending on the context.
     */
    public static final byte VARIABLE = -1;

    /**
     * An array of the bytecode instruction lengths,
     * indexed by the opcode.
     */
	...
	3,        // jsr
	2,        // ret
	VARIABLE, // tableswitch
	VARIABLE, // lookupswitch
	1,        // ireturn
	1,        // lreturn
	1,        // freturn
	1,        // dreturn
    ...
    /**
     * An array, indexed by the opcode, mapping opcodes to opcode
     * classes.
     */
    public static final int[] opcXMap = {
	opcx_nop,             // nop
	opcx_ldc,             // aconst_null
	opcx_ldc,             // iconst_m1
	opcx_ldc,             // iconst_0
	opcx_ldc,             // iconst_1
	opcx_ldc,             // iconst_2
	...
	opcx_dstore,          // dstore
	opcx_astore,          // astore
	opcx_istore,          // istore_0
	opcx_istore,          // istore_1
	opcx_istore,          // istore_2
	opcx_istore,          // istore_3
	opcx_lstore,          // lstore_0
	opcx_lstore,          // lstore_1
	opcx_lstore,          // lstore_2
	opcx_lstore,          // lstore_3
	opcx_fstore,          // fstore_0
	opcx_fstore,          // fstore_1
	opcx_fstore,          // fstore_2
	opcx_fstore,          // fstore_3
	opcx_dstore,          // dstore_0
	opcx_dstore,          // dstore_1
	opcx_dstore,          // dstore_2
	opcx_dstore,          // dstore_3
	opcx_astore,          // astore_0
	opcx_astore,          // astore_1
	opcx_astore,          // astore_2
	opcx_astore,          // astore_3
	opcx_iastore,         // iastore
	opcx_lastore,         // lastore
	opcx_fastore,         // fastore
	opcx_dastore,         // dastore
	opcx_aastore,         // aastore
	opcx_bastore,         // bastore
	opcx_castore,         // castore
	opcx_sastore,         // sastore
	opcx_pop,             // pop
	opcx_pop2,            // pop2
	opcx_dup,             // dup
	opcx_dup_x1,          // dup_x1
	opcx_dup_x2,          // dup_x2
	opcx_dup2,            // dup2
	opcx_dup2_x1,         // dup2_x1
	opcx_dup2_x2,         // dup2_x2
	opcx_swap,            // swap
	opcx_iadd,            // iadd
	opcx_ladd,            // ladd
	opcx_fadd,            // fadd
	...
	opcx_ifgt,            // ifgt
	opcx_ifle,            // ifle
	opcx_if_icmpeq,       // if_icmpeq
	opcx_if_icmpne,       // if_icmpne
	opcx_if_icmplt,       // if_icmplt
	opcx_if_icmpge,       // if_icmpge
	opcx_if_icmpgt,       // if_icmpgt
	opcx_if_icmple,       // if_icmple
	opcx_if_acmpeq,       // if_acmpeq
	opcx_if_acmpne,       // if_acmpne
	opcx_goto,            // goto
	opcx_jsr,             // jsr
	opcx_ret,             // ret
	opcx_switch,          // tableswitch
	opcx_switch,          // lookupswitch
	opcx_ireturn,         // ireturn
	opcx_lreturn,         // lreturn
	opcx_freturn,         // freturn
	opcx_dreturn,         // dreturn
	opcx_areturn,         // areturn
	opcx_return,          // return
	opcx_getstatic,       // getstatic
	opcx_putstatic,       // putstatic
	opcx_getfield,        // getfield
	opcx_putfield,        // putfield
	opcx_invokevirtual,   // invokevirtual
	opcx_invokespecial,   // invokespecial
	opcx_invokestatic,    // invokestatic
	opcx_invokeinterface, // invokeinterface
	opcx_nop,             // xxxunusedxxx
	opcx_new,             // new
	opcx_newarray,        // newarray
	opcx_newarray,        // anewarray
	opcx_arraylength,     // arraylength
	opcx_athrow,          // athrow
	opcx_checkcast,       // checkcast
	opcx_instanceof,      // instanceof
	opcx_monitorenter,    // monitorenter
	opcx_monitorexit,     // monitorexit
	opcx_nop,             // wide
	opcx_multianewarray,  // multianewarray
	opcx_ifnull,          // ifnull
	opcx_ifnonnull,       // ifnonnull
	opcx_goto,            // goto_w
	opcx_jsr,             // jsr_w
	opcx_nop,             // breakpoint
	opcx_nop,             // 203
	opcx_putfield_nowb,   // putfield_nowb
	opcx_putstatic_nowb,  // putstatic_nowb
	opcx_nop,             // 206
	opcx_nop,             // 207
	opcx_nop,             // 208
	opcx_nop,             // 209
	...
	opcx_nop,             // 236
	opcx_rc,              // rc
	opcx_aupdate,         // aupdate
	opcx_supdate,         // supdate
	opcx_aswizzle,        // aswizzle
	opcx_aswrange,        // aswrange
	opcx_nop,             // 242
	opcx_nop,             // 243
	opcx_nop,             // 244
	opcx_nop,             // 245

/*
 * $Id: NunniJXMLParserDTDCState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserDTDCState extends NunniJXMLParserState
{
    private static NunniJXMLParserDTDCState m_instance = null;


    private NunniJXMLParserDTDCState() {}


    static NunniJXMLParserDTDCState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserDTDCState();
        return m_instance;
    }

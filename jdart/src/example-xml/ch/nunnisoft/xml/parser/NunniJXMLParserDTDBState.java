/*
 * $Id: NunniJXMLParserDTDBState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserDTDBState extends NunniJXMLParserState
{
    private static NunniJXMLParserDTDBState m_instance = null;


    private NunniJXMLParserDTDBState() {}


    static NunniJXMLParserDTDBState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserDTDBState();
        return m_instance;
    }
    ...
    void opensqbracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserDTDCState.instance() );
    }

/*
 * $Id: NunniJXMLParserPRETAGSTARTState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserPRETAGSTARTState extends NunniJXMLParserState
{
    private static NunniJXMLParserPRETAGSTARTState m_instance = null;


    private NunniJXMLParserPRETAGSTARTState() {}


    static NunniJXMLParserPRETAGSTARTState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserPRETAGSTARTState();
        return m_instance;
    }
    ...
    void questionmark( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserDOCTYPEState.instance() );
    }


    void escalmatmark( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserCOMMENTAState.instance() );
    }
    ...
    void literal( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ctx.pretagstartLiteral( o );
        }
        catch( LogicError e ) {
            ctx.changeState( NunniJXMLParserTAGNAMEState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserTAGNAMEState.instance() );
    }

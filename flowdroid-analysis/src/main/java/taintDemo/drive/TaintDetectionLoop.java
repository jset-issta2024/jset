...
public class TaintDetectionLoop {
...
//        setTaintParameters4SweepSolver();
        ...
        if (args.length == 0) {
            ...
            try {
                PrintStream print = new PrintStream("/home/lmx/Documents/GitHub/jpf-concolic/jpf-concolic/expeResult/taint/loop/" + fileName + "-" + entryName + ".log");
                System.setOut(print);

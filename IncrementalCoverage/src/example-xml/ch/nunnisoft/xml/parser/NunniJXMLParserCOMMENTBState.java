/*
 * $Id: NunniJXMLParserCOMMENTBState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCOMMENTBState extends NunniJXMLParserState
{
    private static NunniJXMLParserCOMMENTBState m_instance = null;


    private NunniJXMLParserCOMMENTBState() {}


    static NunniJXMLParserCOMMENTBState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCOMMENTBState();
        return m_instance;
    }

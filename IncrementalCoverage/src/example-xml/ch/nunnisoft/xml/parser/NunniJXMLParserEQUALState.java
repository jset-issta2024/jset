/*
 * $Id: NunniJXMLParserEQUALState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserEQUALState extends NunniJXMLParserState
{
    private static NunniJXMLParserEQUALState m_instance = null;


    private NunniJXMLParserEQUALState() {}


    static NunniJXMLParserEQUALState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserEQUALState();
        return m_instance;
    }
    ...
    void squote( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ...
            ctx.changeState( NunniJXMLParserSQOPENState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserSQOPENState.instance() );
    }
    ...
    void dquote( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ...
            ctx.changeState( NunniJXMLParserDQOPENState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserDQOPENState.instance() );
    }

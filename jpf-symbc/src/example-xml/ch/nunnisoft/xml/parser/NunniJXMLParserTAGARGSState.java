/*
 * $Id: NunniJXMLParserTAGARGSState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserTAGARGSState extends NunniJXMLParserState
{
    private static NunniJXMLParserTAGARGSState m_instance = null;


    private NunniJXMLParserTAGARGSState() {}


    static NunniJXMLParserTAGARGSState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserTAGARGSState();
        return m_instance;
    }
    ...
    void literal( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ctx.tagargsLiteral( o );
        }
        catch( LogicError e ) {
            ctx.changeState( NunniJXMLParserLVALUEState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserLVALUEState.instance() );
    }

/*
 * $Id: NunniJXMLParserENDState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserENDState extends NunniJXMLParserState
{
    private static NunniJXMLParserENDState m_instance = null;


    private NunniJXMLParserENDState() {}


    static NunniJXMLParserENDState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserENDState();
        return m_instance;
    }

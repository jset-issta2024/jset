/*
 * $Id: NunniJXMLParserDQOPENState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserDQOPENState extends NunniJXMLParserState
{
    private static NunniJXMLParserDQOPENState m_instance = null;


    private NunniJXMLParserDQOPENState() {}


    static NunniJXMLParserDQOPENState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserDQOPENState();
        return m_instance;
    }
    ...
    void closebracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        try {
            ...
            ctx.changeState( NunniJXMLParserDQRVALUEState.instance() );
            throw e;
        }
        ctx.changeState( NunniJXMLParserDQRVALUEState.instance() );
    }

/*
 * $Id: NunniJXMLParserCOMMENTCState.java,v 1.2 2004/02/07 00:22:04 nunnari Exp $
 *
...
class NunniJXMLParserCOMMENTCState extends NunniJXMLParserState
{
    private static NunniJXMLParserCOMMENTCState m_instance = null;


    private NunniJXMLParserCOMMENTCState() {}


    static NunniJXMLParserCOMMENTCState instance() {
        if ( m_instance == null )
            m_instance = new NunniJXMLParserCOMMENTCState();
        return m_instance;
    }


    void openbracket( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserCOMMENTState.instance() );
    }
    ...
    void minus( NunniJXMLParserFSM ctx,  char o ) throws LogicError {
        ctx.changeState( NunniJXMLParserCOMMENTDState.instance() );
    }
